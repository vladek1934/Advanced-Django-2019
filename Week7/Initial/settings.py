...
SECRET_KEY = '0vp+8ejnb)t633%9t7dwc#4@)5-3r##bvbg4rrvh2)x3bcjag-'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'user_handler': {
            ...
            'filename': 'base/logging/users.log',
            'formatter': 'verbose'
        },
        'actions_handler': {
            'class': 'logging.FileHandler',
            'filename': 'base/logging/actions.log',
            'formatter': 'verbose'
        },
    },
    'loggers': {
